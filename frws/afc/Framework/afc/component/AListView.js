...
AListView.prototype.setData = function(dataArr)
{
	this.removeAllItems();
	
	var items = this.addItem(null, dataArr);
...
AListView.prototype.doRealPattern = function(dataArr, keyArr, queryData, realType)
{
	var item;
