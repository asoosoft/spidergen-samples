...
ADataGrid.prototype._gridClickManage = function(acomp, info, e, isDblClick)
{
...
ADataGrid.prototype._onScrollY = function(acomp, info, e)
{
	...
	{
		this.dataInx = this.showArr2.length - this.scrollBarV.getCountPerArea();
		
		// removeAll 되는 경우 스크롤이벤트가 발생한다.
		// 그 때 위의 dataInx 구하는 방식으로는 음수가 나오게 되므로 최소값인 0으로 세팅한다.
		if(this.dataInx < 0) this.dataInx = 0;
...
ADataGrid.CONTEXT = 
{
	...
	<div data-base="AGrid" data-class="AGrid" class="AGrid-Style" style="width: 200%; height: 100%; left: 0px; top: 0px;">\
